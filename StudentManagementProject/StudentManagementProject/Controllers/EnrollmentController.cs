...
namespace StudentManagementProject.Controllers
{
    public class EnrollmentController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "enrollment_id,student_id,course_id,grade")] Enrollment enrollment)
        {
            ...
            ViewBag.student_id = new SelectList(db.Students, "student_id", "student_name", enrollment.student_id);
            return View(enrollment);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "enrollment_id,student_id,course_id,grade")] Enrollment enrollment)
        {
            if (ModelState.IsValid)
            {
